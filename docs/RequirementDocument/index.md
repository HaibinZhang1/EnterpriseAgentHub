...
- 文档版本：V1.6
- 当前状态：Desktop/API/Tauri 主链、作者治理闭环、审核/管理入口、手机号登录、固定中文分类/标签、本地扫描能力、客户端在线升级需求已整合；Windows 安装包与 Linux live 部署仍待目标环境验收
...
| 09 | [页面：本地 Skill 与发布中心](09_page_myskill.md) | 本地 Skill 列表与发布中心覆盖层、作者治理与提交详情 |
